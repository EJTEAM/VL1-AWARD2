...
<div class="login-container">
		...
		<div class="login-content">
			...
			<a href="index.php" class="logo">
                <?php
                    ...
                    $fbid=$_SESSION['fbid'];
                    // $texte="Veuillez completer votre adresse E-mail pour finir l'inscription ";
                    // if(isSet($_SESSION['google'])) 
                    //     {
                            $texte="Veuillez completer votre numero de telephone pour finir l'inscription ";  
                        //}
                     echo "
	...
	<div class="login-form">
		...
		<?php
		    ...
		    if(isSet($_SESSION['google'])) 
                {
                    require_once("formnewusergoogle.php");           
                } 
            else
                {
                    require_once("formnewuserfb.php");   
                }	
