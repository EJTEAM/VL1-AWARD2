	...
	<div class="sidebar-menu">
		...
		<div class="sidebar-menu-inner">
			...
			<header class="logo-env">
				...
				<div class="logo">
					<a href="index.php">
						<img src="assets/images/blk.png" width="120" alt="" />
					</a>
				</div>
				...
				<li class="">
				 ...
				 <li class="">
					<a href="corp.php?menu=zd">
						...
						<span class="title">Achat SMS</span>
	...
	<div class="main-content">
				...
				<ul class="user-info pull-left pull-none-xsm">
					...
					<li class="profile-info dropdown"><!-- add class "pull-right" if you want to place this from right -->
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							<img src="assets/images/111.jpg" alt="" class="img-circle" width="44" />
						<?php 
     ...
     $pass=$_POST['pass'];
      ...
      $prenom=$_SESSION['prenom'];
		    ...
		    echo "<p style='text-transform:uppercase;'>$prenom&nbsp;$nom</p>";
...
<?php 
					...
					switch ($menu) 
						{
							...
							case 'non':
                               ...
                               case 'del':
								...
								case 'mmm':
										require_once('menu/marche_m.php');
		...
		<footer class="main">
			...
			&copy; 2020 <strong>EJ SMS</strong> Powered By <a href="http://hosting.eliajimmy.net" target="_blank">EJ SARL</a>
