  ...
  paypal.Buttons({
    ...
    onApprove: function(data, actions) {
      ...
      return actions.order.capture().then(function(details) {
        ...
        window.location.href="https://sms.eliajimmy.net/corp.php?menu=paypal&prix="+montant+"&service="+quantite+"&productid="+productid+"&nomsend="+nomsend+"&prenomsend="+prenomsend;
