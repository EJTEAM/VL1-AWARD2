			...
			<div class="col-md-12">
				...
				<div class="panel panel-primary" data-collapsed="0">
					...
					<div class="panel-heading">
						...
						<h2 style="text-align: center;">Importer les  membres </h2>
					</div>
						...
						<div class="form-group" id="design_numero">
							<div class="input-group">
								<div class="input-group-addon">
									...
									<input type="file"  name="excel" id="excel" class="form-control file2 inline btn btn-primary" data-label="<i class='glyphicon glyphicon-file'></i> Importer" />
