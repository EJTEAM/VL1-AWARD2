		...
		<table class="table table-bordered datatable" id="table-1">
			<thead>
				<tr>
					...
					<th>Etat SMS envoyés</th>
					<th>Reception</th>
					<th data-hide="phone,tablet">Date et Heure</th>
					<th>Nettoyer</th>
			...
			<tbody>
                     ...
                     $connexion = mysqli_connect("localhost", "eliajimm_sms",  "j'utiliseSMS243","eliajimm_sms");
							 ...
							 $requet="SELECT * FROM `rapport` WHERE iduser='$id' AND status='UNDELIV' ORDER BY id DESC";
                ...
                <tr class='odd gradeX'>
					...
					<td>
						<a href='corp.php?menu=sprund&iduser=$iduser&telephone=$telephone' class='btn btn-danger'>
