...
echo"
				<tr class='odd gradeX'>
					...
					<td>$codegroupe</td>
					<td>
					<a href='corp.php?menu=dtte&id=$id&nom=$nom&prenom=$prenom&telephone=$telephone&codegroupe=$codegroupe' class='btn btn-danger btn-sm btn-icon icon-left'> <i class='entypo-cancel'></i>
					Suprimer
					</a></td>
				</tr>
				   ";
